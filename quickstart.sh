...
echo ""
echo "   # Option 1: Using environment variables (default)"
...
echo "   # Option 3: Mix of both (command line takes precedence)"
echo "   ./bin/minio-prometheus-sd -bucket-pattern='prod-*' -scrape-interval=30s"
echo ""
